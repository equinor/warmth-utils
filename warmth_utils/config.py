...
class UTIL_SETTINGS(BaseSettings):
    ...
    TENANT_ID: UUID4
    CACHEDIR: str = "./"
    SIMULATIONDATASPACEPREFIX: str = "BASINSIMULATION"
    MODELSPEC:str
    RDDMSURL: str
    OSDUHOST: str
    OSDUPARTITION: str
    ...
    MESHMANIFESTVERSION:str = "1.2.0"
    FILEMANIFESTVERSION:str = "1.1.0"
    WELLLOGMANIFESTVERSION:str = "1.5.0"
    MAPMANIFESTVERSION:str = "1.2.0"
